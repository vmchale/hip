...
--
downsample :: ColorSpace cs e =>
              (Int -> Bool) -- ^ Rows predicate
           -> (Int -> Bool) -- ^ Columns predicate
           -> Image cs e -- ^ Source image
           -> Image cs e
downsample mPred nPred = transmute getNewDims getNewPx
  where
    getNewDims (m :. n) =
...
--
flipV :: ColorSpace cs e => Image cs e -> Image cs e
...
--
flipH :: ColorSpace cs e => Image cs e -> Image cs e
...
--
rotate90 :: ColorSpace cs e => Image cs e -> Image cs e
...
--
rotate180 :: ColorSpace cs e => Image cs e -> Image cs e
...
--
rotate270 :: ColorSpace cs e => Image cs e -> Image cs e
...
--
rotate :: (ColorSpace cs e, Interpolation method) =>
...
--
scale :: (ColorSpace cs e, Interpolation method) =>
         method -- ^ Interpolation method to be used during scaling.
      -> Border (Pixel cs e) -- ^ Border handling strategy
